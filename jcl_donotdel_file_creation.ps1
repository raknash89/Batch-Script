...
$content = Get-Content -Path @("D:\gowrishankar.p\Bat_script\file_list_old.txt")  # IBM job submit tempate

$jcl = 'D:\gowrishankar.p\Bat_script\dondel.jcl'					 # Raincode  FTPied PDS file path
